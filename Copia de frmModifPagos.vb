...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    Friend WithEvents FwiFechaPagonew As Solmicro.Expertis.Engine.UI.CalendarBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.FwiFechaPagonew = New Solmicro.Expertis.Engine.UI.CalendarBox
        ...
        Me.Panel1.Controls.Add(Me.FwiFechaPagonew)
        ...
        Me.Label1.Text = "Nueva Fecha Pago"
        '
        'FwiFechaPagonew
        '
        Me.FwiFechaPagonew.Anchor = CType((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.FwiFechaPagonew.DisabledBackColor = System.Drawing.Color.White
        Me.FwiFechaPagonew.Location = New System.Drawing.Point(536, 80)
        Me.FwiFechaPagonew.Name = "FwiFechaPagonew"
        Me.FwiFechaPagonew.Size = New System.Drawing.Size(104, 21)
        Me.FwiFechaPagonew.TabIndex = 32
        '
        'lblFwIFPagoNew
        '
...
#End Region
    ...
    Private Sub CmbAceptar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdAceptar.Click
        If Grid.RecordCount > 0 Then
            If Length(FwiFechaVtoNew.Value) > 0 Or Length(FwIDBancoNew.Text) > 0 Or Length(FwIFPagoNew.Text) > 0 Or Length(FwiFechaPagonew.Value) > 0 Then
        ...
        Select Case e.Column.Key
            ...
            Case "CContable"
                ...
                Else
                    e.Column.ButtonStyle = ButtonStyle.Image
                End If
            Case "ImpVencimiento", "ImpVencimientoA", "ARepercutir", "ImporteRemesaAnticipo", "Titulo", "CambioA", "CambioB"
                If blnNoEditar Then
                    e.Cancel = True
                End If
